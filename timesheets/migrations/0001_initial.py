...
class Migration(migrations.Migration):
    ...
    operations = [migrations.CreateModel(name='Timesheets',
        fields=[('key', models.AutoField(primary_key=True, serialize=False)), ('time_spent', models.FloatField()),
            ('description', models.TextField(blank=True, null=True)), ('activity_date', models.DateField()),
        ...
        options={'db_table': 'timesheets', 'managed': False, }, ), migrations.CreateModel(name='Users',
